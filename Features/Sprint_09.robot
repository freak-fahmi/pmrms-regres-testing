...
Scenario PMRMS-655 User melakukan pencarian data by nama kegiatan
    event.Search Pencarian by Nama Kegiatan    Nama Event
...
Scenario PMRMS-472 Search Nama Event
    Search Kode Kegiatan    Event Demo Agustus Swakelola
    event.Click Button Cari
...
Scenario PMRMS-472 Search Nama Event
    Search Kode Kegiatan    Event 27 juli Pengisian Formulir Yang sudah melewati batas waktu
    event.Click Button Cari
    Lihat Detail Kegiatan
    Click Tab Laporan Event
...
##### Update Data Supaya bisa digunakan, saat ini lewat semua
Scenario 15: Search Nama Kegiatan
    kegiatan.Search Pencarian by Nama Kegiatan    Automation Testing jokbg
...
Scenario 34 : Buat Laporan Kegiatan LSP
    kegiatan.Search Pencarian by Nama Kegiatan    Automation Testing tmcxz
    kegiatan.Click Button Cari
    Scenario: Click Lihat Detail Kegiatan
    Scenario: Click Laporan Kegiatan
