...
414 Scenario : Membuat Dokumen Concept Note
    ...
    event.Search Pencarian by Nama Kegiatan    badrus4
...
#    belum ada test data
#    autotest3 gabisa dibikin laporan kegiatan nya kalo pake Konsultan ini

#     yang ini dari file 19_    | scenario 34
653 Scenario : Membuat Laporan Kegiatan
    Login valid as Konsultan
    kegiatan.Search Pencarian by Nama Kegiatan    demo31agustus7
...
654 Scenario : Mengetahui Laporan Kegiatan
    ...
    kegiatan.Search Pencarian by Nama Kegiatan    Automation Testing toxsh
    kegiatan.Click Button Cari
    Lihat Detail Kegiatan
    kegiatan.Click Laporan Kegiatan
    Finish Testcase
...
#     ini dari 19_ | Scenario 34
    Login valid as PTM89
    kegiatan.Search Pencarian by Nama Kegiatan    autektk0055
    kegiatan.Click Button Cari
    Lihat Detail Kegiatan
    kegiatan.Click Laporan Kegiatan
    kegiatan.Enter Buat Laporan Kegiatan
...
660 Scenario : Positive - Merevisi Laporan Kegiatan "Kontrak" (LSP)
     # ini dari 19_ | Scenario 37-38
     # atau dari 19_ | Scenario 44-45
     # 44-45
    Login valid as PTM89
    kegiatan.Search Pencarian by Nama Kegiatan    autektk0055
    kegiatan.Click Button Cari
...
664 Scenario : Mengetahui Laporan Event
    Login valid as Koordinator
    event.Search Pencarian by Kode Kegiatan    event 20 mei swakelola sudah berlangsung
    event.Click Button Cari
    event.Lihat Detail Event From Table List    1
...
734 Scenario : Membuat Concept Note
    Login valid as Koordinator
    Buat Concept Note    Kegiatan Agustus
    pcu.Fill Data Umum Koordinator
    pcu.Fill Data Pelaksanaan    PCU    Maluku Utara    Susi Yani
    pcu.Fill Data Event
    Finish Testcase
